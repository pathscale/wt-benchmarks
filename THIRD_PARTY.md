...
| SQLite speedtest1 | https://sqlite.org/cgi/src/file/test/speedtest1.c | Public domain | Independently implemented nine core operation shapes; no upstream source copied. A feature-gated `rusqlite` 0.40.1 adapter embeds SQLite and runs the same deterministic inputs/checksums as WorkTable. Unsupported SQL groups, bulk-transaction semantics, and durable-mode equivalence are not claimed. |
